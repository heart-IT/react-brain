...
export const FEATURE_DOMAINS = ['auth/identity', 'bottom sheets', 'media', 'maps', 'calendars', 'payments', 'charts', 'editors', 'games/3D/AR-VR', 'on-device AI', 'AI UI', 'AI dev tooling', 'OTA updates', 'networking', 'polish (toasts/haptics/splash)', 'i18n', 'native-ui (widgets/Live Activities)', 'keyboard', 'desktop shell'];
