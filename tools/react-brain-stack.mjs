...
export const FEATURE_DOMAINS = ['media', 'maps', 'calendars', 'payments', 'charts', 'editors', 'games', 'on-device AI', 'AI UI', 'AI dev tooling', 'OTA updates', 'i18n', 'native-ui (widgets/Live Activities)', 'keyboard', 'desktop shell'];
